    ...
    <style>
        ...
        * {
        ...
        #security-section input {
            ...
            padding: 8px 0px;
            border: none;
            border-bottom: 1px solid var(--borda-campo);
            border-radius: 0;
        ...
        #account-data-section input:focus,
        #account-data-section select:focus {
            outline: none;
            border-color: var(--azul-destaque);
            box-shadow: 0 0 0 3px rgba(36, 88, 191, 0.15);
        }
...
<body>
    ...
    <svg width="0" height="0" style="position:absolute">
        <defs>
            ...
            <symbol id="icon-close" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"
                stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="row">
            <div class="profile-column">
                <div class="card profile-card">
                    ...
                    <button
                        class="profile-name-button"><?php echo htmlspecialchars($_SESSION['user']['name'] ?? 'Usuário'); ?></button>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group-wrapper form-group">
                                ...
                                <input type="text" id="name"
                                    value="<?php echo htmlspecialchars($_SESSION['user']['name'] ?? ''); ?>" readonly>
        ...
        <div class="row">
            <div class="account-data-column">
                <div class="form-section-wrapper" id="account-data-section">
                    ...
                    <div class="card">
                        <form class="form-grid" id="account-details-form" method="POST"
                            action="/nexus-erp/public/account/update">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="company-business-name" name="business_name"
                                    value="<?php echo htmlspecialchars($company['business_name'] ?? ''); ?>">
                            </div>

                            <div class="form-row">
                                <div class="form-group">
                                    <label for="company-doc">Documento (CNPJ/CPF)*</label>
                                    <input type="text" id="company-doc" name="document_number"
                                        value="<?php echo htmlspecialchars($company['document_number'] ?? ''); ?>"
                                        required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="company-ie" name="state_registration"
                                        value="<?php echo htmlspecialchars($company['state_registration'] ?? ''); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="company-im">Inscrição Municipal</label>
                                    <input type="text" id="company-im" name="municipal_registration"
                                        value="<?php echo htmlspecialchars($company['municipal_registration'] ?? ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="company-street" name="address_street"
                                    value="<?php echo htmlspecialchars($company['address_street'] ?? ''); ?>">
                            </div>

                            <div class="form-row">
                                <div class="form-group">
                                    <label for="company-number">Número</label>
                                    <input type="text" id="company-number" name="address_number"
                                        value="<?php echo htmlspecialchars($company['address_number'] ?? ''); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="company-complement">Complemento</label>
                                    <input type="text" id="company-complement" name="address_complement"
                                        value="<?php echo htmlspecialchars($company['address_complement'] ?? ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="company-neighborhood" name="address_neighborhood"
                                        value="<?php echo htmlspecialchars($company['address_neighborhood'] ?? ''); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="company-zipcode">Código Postal (CEP)</label>
                                    <input type="text" id="company-zipcode" name="address_zipcode"
                                        value="<?php echo htmlspecialchars($company['address_zipcode'] ?? ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="company-city" name="address_city"
                                        value="<?php echo htmlspecialchars($company['address_city'] ?? ''); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="company-state">Estado (UF)</label>
                                    <input type="text" id="company-state" name="address_state" maxlength="2"
                                        value="<?php echo htmlspecialchars($company['address_state'] ?? ''); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="company-country">Cód. País</label>
                                    <input type="text" id="company-country" name="address_country_code" maxlength="4"
                                        value="<?php echo htmlspecialchars($company['address_country_code'] ?? '1058'); ?>">
                                </div>
                            </div>
    ...
    <div class="modal-overlay" id="password-modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <svg class="modal-close-btn close-modal">
