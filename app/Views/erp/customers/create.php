...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="/nexus-erp/public/customers/store">
            <div class="card">
                ...
                <div class="form-container form-grid">
                    ...
                    <div class="form-row-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="address_state" name="address_state" maxlength="2" required>
                        </div>
                        <div class="form-group">
                            <label for="address_zipcode">CEP*</label>
                            <input type="text" id="address_zipcode" name="address_zipcode" maxlength="8" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="text-align: right; margin-top: 20px;">
                <button type="submit" class="btn-primary" style="font-size: 1.1rem; padding: 16px 24px;">Salvar Cliente</button>
            </div>
        </form>
    </div>
</body>
